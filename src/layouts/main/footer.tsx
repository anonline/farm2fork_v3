...
const LINKS = [
    {
        ...
        children: [
            ...
            { name: 'Zöldségek', href: paths.home },
            { name: 'Gyümölcsök', href: paths.home },
            { name: 'Gombák', href: paths.home },
            { name: 'Feldolgozott termékek', href: paths.home },
            { name: 'Egyéb termékek', href: paths.home },
            { name: 'Pékáru', href: paths.home },
        ],
    },
    {
        headline: 'Tudnivalók',
