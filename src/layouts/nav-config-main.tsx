                ...
                items: [
                    {
                        ...
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-01.png`,
                    },
                    {
                        title: 'Gyümölcsök',
                        path: paths.categories.gyumolcsok,
                        subtitle: 'Alma, körte, barack, áfonya...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-06.png`,
                    },
                    {
                        title: 'Feldolgozott termékek',
                        path: paths.categories.feldolgozottTermekek,
                        subtitle: 'Liszt, rizs, méz, lekvár...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-07.png`,
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        ...
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-08.png`,
                    },
                    {
                        title: 'Gombák',
                        path: paths.categories.gombak,
                        subtitle: 'Csiperke, laska, shiitake...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-04.png`,
                    },
                    {
                        title: 'Pékáru',
                        path: paths.categories.pekaru,
                        subtitle: 'Kenyér, baguette, kifli, gofri...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-09.png`,
                    },
                ],
            },
            {
                ...
                items: [
                    {
                        ...
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-02.png`,
                    },
                    {
                        title: 'Fűszernövények',
                        path: paths.categories.fuszernovenyek,
                        subtitle: 'Bazsalikom, rozmaring...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-03.png`,
                    },
                    {
                        title: 'Egyéb termékek',
                        path: paths.categories.egyeb,
                        subtitle: 'Tojás, olajos magok...',
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-05.png`,
                    },
                ],
            },
        ],
        ...
        children: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        icon: `${CONFIG.assetsDir}/illustrations/menu/f2f_ikonok-10.svg`,
                    },
                    {
                        title: 'GYIK',
                        path: paths.faqs,
