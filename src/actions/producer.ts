...
export function useGetProducers() {
    ...
    const { data, isLoading, error, isValidating } = useSWR<ProducersData>(
        'producers',
        async () => {
...
export function useGetProducer(producerId: string) {
    ...
    const { data, isLoading, error, isValidating } = useSWR<ProducerData>(
        'producer',
        async () => {
...
export function useSearchProducers(query: string) {
    ...
    const { data, isLoading, error, isValidating } = useSWR<ProducerSearchResultsData>(
        url,
        async () => {
            const response = await supabase
                .from('Producers')
