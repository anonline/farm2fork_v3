...
const textContent = () => (
    <>
        ...
        <Typography sx={{ color: 'text.secondary' }}>
            Lorem ipsum odor amet, consectetuer adipiscing elit. Inceptos dolor posuere felis
            euismod, placerat iaculis netus euismod. Lacus nullam fermentum lacus diam quam. Nam
            facilisis porttitor malesuada diam platea pulvinar finibus. Scelerisque facilisi in
            etiam, accumsan mattis ad. Integer condimentum eu dis curae conubia finibus. Justo
            placerat aptent erat aptent; leo quam rhoncus.
        </Typography>
    </>
);
...
export function LayoutView() {
    ...
    return (
        <ComponentLayout heroProps={{ heading: 'Layout' }} containerProps={{ maxWidth: 'lg' }}>
            ...
            <Paper
                variant="outlined"
                sx={{ height: 800, overflow: 'hidden', bgcolor: 'transparent' }}
            >
