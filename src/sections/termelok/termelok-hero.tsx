        ...
        >
            ...
            <Box sx={{
                ...
                <Stack spacing={3}>
                    ...
                    <>
                        <Stack spacing={2} sx={{ flexDirection: {xs:"column", lg:"row"}, gap:{xs:3, lg:"120px"} }}>
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <F2FIcons name='Map' height={24} width={24} style={IconStyle}/>
                                <Typography variant="body1" sx={IconTextStyle}>{producer.location}</Typography>
                            </Stack>
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <F2FIcons name='House' height={24} width={24} style={IconStyle}/>
                                <Typography variant="body1" sx={IconTextStyle}>{producer.companyName}</Typography>
                            </Stack>
                        </Stack>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <F2FIcons name='Apple' height={24} width={24} style={IconStyle}/>
                            <Typography variant="body1" sx={IconTextStyle}>{producer.producingTags}</Typography>
                        </Stack>
                    </>
                    <Typography
                        sx={{
