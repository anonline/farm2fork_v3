...
export default function RolunkTeam() {
    return (
        <Container sx={{ marginTop: "40px", marginBottom: "40px", fontSize: "16px", fontWeight: "400", lineHeight: "24px", textAlign: "start", alignSelf: "auto", minWidth: "100%", }}>
            <Container>
