        ...
        <Grid container rowSpacing={1}>
            ...
            <Grid size={{ xs: 12, sm: 12, md: 12, lg: 6, xl: 6 }}>   
                <Box sx={{ minWidth:"350px", flexDirection: "column", justifyContent: "center", height: "100%", padding: "20px" }}>
                    <Typography sx={{ textTransform: "uppercase", fontSize:"28px", fontWeight: "bold", fontFamily:"Bricolage Grotesque, Sans-serif", }} component="h2" gutterBottom>Horváth Boldizsár</Typography>
