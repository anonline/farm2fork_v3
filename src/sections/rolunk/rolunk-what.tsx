...
export default function RolunkWhat() {
  ...
  const categoriesTexts = [
    {
      title: 'SZEZONÁLIS',
      description: 'A kínálatban a szezonális alapanyagoké a főszerep, mivel a zöldségek és gyümölcsök az adott szezonukban rendelkeznek magasabb tápanyagtartalommal és ízben is kiválóak.',
    ...
    {
      title: 'BIO',
      description: 'Célunk, hogy minél magasabb arányban jelenjenek meg a bio alapanyagok, ezzel is hangsúlyozva a tudatos és egészséges táplálkozást, valamint a környezeti értékek megóvásának fontosságát.',
    ...
    {
      title: 'HAZAI',
      description: 'Minden nap azon dolgozom, hogy a magyar termelőket összekössem a top éttermekkel és a kiváló minőségű, helyi alapanyagokra nyitott lakossági megrendelőkkel.',
    ...
    },
    {
      ...
      description: 'A működésünk során nagy hangsúlyt fektetünk a környezetbarát megoldásokra és a csomagolások minimalizálására.',
    ...
    {
      title: 'FAIR TRADE',
      description: 'Partnereimmel méltányos kereskedelemi formát alakítottam ki, így a rendeléseddel te is közvetlenül támogathatod a magyar bio- és konvencionális termelőket.',
    ...
    {
      title: 'FARM TO TABLE',
      description: 'A farm-to-table elvnek megfelelően célom, hogy a szállított zöldségek és gyümölcsök minél kevesebbet utazzanak a termelés helyétől a felhasználást jelentő konyháig.',
