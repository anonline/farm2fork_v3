...
export default function KiszalitasiCimekKapcsolo() {
    ...
    const [selectedDeliveryMethod, setSelectedDeliveryMethod] = useState(ShippingMethodsEnum.hazhozszallitas);
            ...
            <Box sx={{ mt: 3 }}>
                {selectedDeliveryMethod == ShippingMethodsEnum.hazhozszallitas && (
                    <>
                        ...
                        <AtveteliPontInfo data={HAZHOZSZALLITAS_KERULET_INFO_ADAT} titleStyle={infoCardtitleStyle} />
                    </>
                )}
                ...
                {selectedDeliveryMethod == ShippingMethodsEnum.atveteli_pontok && (
                    <>
                        ...
                        <AtveteliPontInfo data={ATVETELIPONT_INFO_ADAT} titleStyle={infoCardtitleStyle} />
                    </>
                )}
            </Box>
        </Box>
...
function AtveteliPontInfo({ data, titleStyle }: Readonly<AtveteliPontInfoProps>) {
    return (
        <Box sx={{ pt: 2, }}>
            {data.map((card) => (
                <Box key={card.title} sx={{ mb: 2, border: "1px solid rgb(223, 220, 209)", borderRadius: "4px", padding: "18px" }}>
