                                    ...
                                    {dataFiltered
                                        ...
                                        .map((row) => (
                                            <InvoiceTableRow
                                                ...
                                                detailsHref={paths.dashboard.invoice.details(
                                                    row.id
                                                )}
                                            />
                                        ))}
...
function applyFilter({ inputData, comparator, filters, dateError }: ApplyFilterProps) {
    ...
    if (name) {
        inputData = inputData.filter(({ invoiceNumber, invoiceTo }) =>
            [invoiceNumber, invoiceTo.name, invoiceTo.company, invoiceTo.phoneNumber].some(
                (field) => field?.toLowerCase().includes(name.toLowerCase())
            )
        );
    }
