    ...
    const renderContent = () => {
        if (isAdding) {
            if (addressType === 'shipping') {
                return <NewShippingAddressForm onSave={handleAddNewAddress} onCancel={() => setIsAdding(false)} />;
            } else {
                return <NewBillingAddressForm onSave={handleAddNewAddress} onCancel={() => setIsAdding(false)} />;
            }
        }
        ...
        <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap={2}>
                ...
                <Button 
                    ...
                    sx={{ 
                        display:"flex", flexDirection:"row", letterSpacing:"0.16px",
                        fontWeight:700, fontSize:"16px", lineHeight:"20px",
                        bgcolor: 'rgb(70, 110, 80)', gap:1,
